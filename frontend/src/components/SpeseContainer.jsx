...
const SpeseContainer = ({ spese, onDelete, onUpdate }) => {
  ...
  return (
    ...
    ${
      saldoMese >= 0 ? "bg-green-200 text-green-800" : "bg-red-200 text-red-800"
    }`}
      >
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex flex-col w-full md:w-1/2">
          ...
          <div className="mt-2 p-3 bg-green-200 rounded-xl text-center font-semibold">
        ...
        <div className="flex flex-col w-full md:w-1/2">
          <SpeseList
            ...
            onUpdate={onUpdate}
          />
          <div className="mt-2 p-3 bg-red-300 rounded-xl text-center font-semibold">
